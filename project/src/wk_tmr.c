...
void wk_tmr1_init(void)
{
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_1, 2400);
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_2, 2400);
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_3, 2400);
  ...
  tmr_channel_value_set(TMR1, TMR_SELECT_CHANNEL_4, 2400);
...
void wk_tmr8_init(void)
{
  ...
  tmr_output_channel_immediately_set(TMR8, TMR_SELECT_CHANNEL_4, FALSE);
  ...
  /**
   * Users need to configure TMR8 interrupt functions according to the actual application.
   * 1. Call the below function to enable the corresponding TMR8 interrupt.
